...
// import awaitDistrService from '../../../service/hms/assess/await_distr'
    ...
    async get() {
        ...
        try {
            ...
            if (this.req.params.id) {
                ...
                rs.data.total = await batchService.count(awaitMap);


                data = await distrService.findAwaitDistr(map, paginates, orderby);
